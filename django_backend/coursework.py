...
def linear_time_trend(user_data):
    ...
    for column in user_data:
        ...
        preprocessed_data['y*t'] = [round(preprocessed_data['data'][i]*preprocessed_data['t'][i], 1) for i in range(len(user_data[column]))]
...
def logarithmic_time_trend(user_data):
    ...
    for column in user_data:
        ...
        preprocessed_data['y*ln(t)'] = [round(preprocessed_data['data'][i]*preprocessed_data['ln(t)'][i], 1) for i in range(len(user_data[column]))]
...
def hyperbolic_time_trend(user_data):
    ...
    for column in user_data:
        ...
        preprocessed_data['y*1/t'] = [round(preprocessed_data['data'][i]*preprocessed_data['1/t'][i], 1) for i in range(len(user_data[column]))]
